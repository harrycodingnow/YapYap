      ...
      <View style={styles.overlay}>
        <View style={[styles.popup, isDarkMode && styles.popupDark]}>
          ...
          <View style={styles.header}>
            <Ionicons name="megaphone" size={24} color="#FDBA74" />
          ...
          <View style={styles.content}>
            <View style={styles.bulletPoint}>
              <Text style={[styles.bullet, isDarkMode && styles.bulletDark]}>
                •
              </Text>
              <Text
                style={[styles.bulletText, isDarkMode && styles.bulletTextDark]}
              >
                {t("welcome.bullet1")}
              </Text>
            </View>
